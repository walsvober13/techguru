...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (navToggle && navMenu) {
    navToggle.addEventListener("click", () => {
      ...
      // Close services dropdown when opening hamburger menu
  ...
  // ============================================
  // SERVICES COMMAND CENTER DROPDOWN
  // ============================================
  const servicesToggle = document.getElementById("tg-nav-services-toggle");
  const servicesDropdown = document.getElementById("tg-services-dropdown");
  ...
  if (servicesToggle && servicesDropdown) {
    ...
    // Close dropdown when clicking a link (after smooth scroll)
    servicesDropdown.querySelectorAll(".tg-mega-link").forEach((link) => {
      link.addEventListener("click", () => {
        // Delay close slightly for visual feedback
        setTimeout(closeServicesDropdown, 150);
      });
    });
    ...
    document.addEventListener("keydown", (e) => {
      if (e.key === "Escape" && servicesDropdown.classList.contains("active")) {
        closeServicesDropdown();
      ...
      try {
        ...
        if (res.ok) {
          exitPopupForm.innerHTML =
            '<p style="color: var(--color-accent);">✓ You\'re in! Check your inbox.</p>';
        ...
        console.error(err);
        exitPopupForm.innerHTML =
          '<p style="color: #ff6b6b;">Something went wrong. Try again later.</p>';
      }
    });
  }
  ...
  if (subscribeForm) {
    subscribeForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        showFormMessage(
          subscribeForm,
          "✓ Success! Check your inbox for the starter kit.",
          "success",
        );
        subscribeForm.reset();
      } catch (err) {
